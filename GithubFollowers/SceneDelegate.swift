...
class SceneDelegate: UIResponder, UIWindowSceneDelegate {
    ...
    func scene(_ scene: UIScene, willConnectTo session: UISceneSession, options connectionOptions: UIScene.ConnectionOptions) {
        ...
        // Create a window with the windowScene
        window = UIWindow(frame: windowScene.coordinateSpace.bounds) // --> Use .coordinateSpace.bounds to make it take up the whole screen
    ...
    // Create a navigation controller (Navigation View in SwiftUI)
